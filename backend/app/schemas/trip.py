...
class TripRequest(BaseModel):
    ...
    start_date: str = Field(..., description="开始日期 YYYY-MM-DD", examples=["2026-04-01"])
    end_date: str = Field(..., description="结束日期 YYYY-MM-DD", examples=["2026-04-03"])
...
class Attraction(BaseModel):
    ...
    photos: Optional[List[str]] = Field(default_factory=list, description="景点图片 URL 列表")
